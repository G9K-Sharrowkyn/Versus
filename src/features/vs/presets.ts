...
export const FIGHT_SCENARIO_CANONICAL_TOKEN_TO_ID: Record<string, FightScenarioId> = {
  ...
  cosmicsalvo: 'cosmic-salvo',
  voidclash: 'void-clash',
  celestialpurge: 'celestial-purge',
  shadowsurge: 'shadow-surge',
  infiniteattrition: 'infinite-attrition',
  bladeentrapment: 'blade-entrapment',
  ragnarokunleashed: 'ragnarok-unleashed',
  abysscorruption: 'abyss-corruption',
  novacleansing: 'nova-cleansing',
  voidabsorption: 'void-absorption',
  allblackexecution: 'all-black-execution',
