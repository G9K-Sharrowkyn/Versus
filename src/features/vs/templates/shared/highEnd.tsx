...
export const HIGH_END_HEADER_CLASS = 'text-center text-[44px] uppercase leading-[1.02] tracking-[0.02em] text-slate-100'

export const HIGH_END_SUBTEXT_CLASS = 'mt-2 text-center text-[12px] uppercase leading-[1.2] tracking-[0.16em] text-slate-300'

export const HIGH_END_TEMPLATE_HEADER_SHELL_CLASS =
  'grid grid-cols-[1fr_auto_1fr] items-stretch gap-4 border-b border-cyan-300/25 pb-3 text-[11px] text-slate-300'

export const HIGH_END_TEMPLATE_HEADER_META_CLASS = 'flex min-w-[238px] flex-col justify-center space-y-1 text-left'

export const HIGH_END_TEMPLATE_HEADER_CENTER_CLASS =
  'flex h-[148px] min-h-[148px] max-h-[148px] flex-col items-center justify-center px-3 py-2 text-center'

export const HIGH_END_TEMPLATE_HEADER_LOGO_WRAP_CLASS = 'flex items-start justify-end pt-2'
...
export const HIGH_END_BODY_GAP_CLASS = 'mt-3'
