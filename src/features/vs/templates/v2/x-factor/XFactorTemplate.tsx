                  ...
                  {isSuperOvercharge && (
                    ...
                    >
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--1">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.04, y: 0.22 }} endRatio={{ x: 1.28, y: 0.52 }} />
                      </div>
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--2">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.12, y: 0.78 }} endRatio={{ x: 1.24, y: 0.34 }} />
                      </div>
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--3">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.28, y: 0.48 }} endRatio={{ x: 1.36, y: 0.62 }} />
                      </div>
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--4">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.08, y: 0.56 }} endRatio={{ x: 1.18, y: 0.8 }} />
                      </div>
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--5">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.2, y: 0.3 }} endRatio={{ x: 1.4, y: 0.42 }} />
                      </div>
                      <div className="vs-xfactor-overcharge-arc vs-xfactor-overcharge-arc--6">
                        <LightningCanvas detailMode="compact" frameIntervalMs={18} startRatio={{ x: 0.34, y: 0.68 }} endRatio={{ x: 1.32, y: 0.7 }} />
                      </div>
                    </div>
                  )}
                </div>
