  ...
  return (
    <div className="vs-tactical-board25-surface">
      ...
      <div className="vs-tactical-board25-reality">
        <p className="vs-tactical-board25-reality-heading" data-marvin-id="NAGLOWK_PRAWY" data-marvin-file={CURRENT_FILE} style={{ color: BLUE_EKSTREMALNY, zIndex: 10, textShadow: REFLEKS_NAGLOWKOW_PANELI }}>{realityHeader}</p>
