  ...
  templates: [
    {
      ...
      variableFields: [
        field('headline', ['header', 'title']),
        field('subtitle', ['purpose', 'note']),
        field('left_header', ['categories_header']),
        field('right_header', ['reality_header']),
        field('linear_label'),
        field('chaos_label'),
    ...
    },
    {
      ...
      variableFields: [
        field('header', ['title', 'headline']),
        field('world', ['swiat', 'version']),
        field('style'),
        field('atut', ['advantage']),
        field('mentalnosc', ['mentality']),
        field('quote', ['cytat']),
      ],
      defaultFields: {
    ...
    },
    {
      ...
      subtitle: text('Odczyt statystyk dwóch profili', 'Two-profile stat readout'),
    ...
    },
    {
      ...
      subtitle: text('Podsumowanie', 'Summary'),
    ...
    },
    {
      ...
      variableFields: [
        field('headline', ['header', 'title']),
        field('subtitle', ['purpose', 'note']),
        field('col_left', ['solar_flare_yes', 'solarflare_yes']),
        field('col_right', ['solar_flare_no', 'solarflare_no']),
        field('row_top', ['standard', 'standard_ko']),
        field('row_bottom', ['deathmatch', 'kill_only']),
        field('case_1', ['case1']),
        field('case_2', ['case2']),
        field('case_3', ['case3']),
        field('case_4', ['case4']),
    ...
    {
      id: 'new-template',
      activeName: text('Nowy template', 'New template'),
      description: text('Puste pole robocze pod kolejny layout.', 'Working blank field for the next layout.'),
      title: text('NOWY TEMPLATE', 'NEW TEMPLATE'),
      subtitle: text('Pole placeholder', 'Placeholder area'),
      blockName: text('Nowy Template', 'New Template'),
      purpose: text('Puste pole robocze pod kolejny layout.', 'Working blank field for the next layout.'),
      aliases: ['new template', 'blank template', 'nowy template', 'empty field'],
      legacyIds: ['blank-template'],
      variableFields: [
        field('headline', ['header', 'title']),
        field('subtitle', ['purpose', 'note']),
        field('line_1', ['line1']),
    ...
    },
    {
      ...
      variableFields: [
        ...
        field('subtitle', ['purpose', 'note', 'line_2', 'line2']),
        field('top_color_a', ['top_primary', 'fighter_a_color_a', 'fighter_a_primary']),
        field('top_color_b', ['top_secondary', 'fighter_a_color_b', 'fighter_a_secondary']),
        field('bottom_color_a', ['bottom_primary', 'fighter_b_color_a', 'fighter_b_primary']),
        field('bottom_color_b', ['bottom_secondary', 'fighter_b_color_b', 'fighter_b_secondary']),
        field('top_dark', ['fighter_a_dark']),
        field('bottom_dark', ['fighter_b_dark']),
      ],
    },
    {
      id: 'methodology',
